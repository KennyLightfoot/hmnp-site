...
const requiredFields = [
  ...
  'cf_quote_sent_date',
  // Added from GHL_Workflow_Details.md analysis
  'cf_contact_inquiry_subject',
  'cf_contact_inquiry_message',
  'cf_booking_appointment_datetime',
  'cf_booking_appointment_time_only',
  'cf_booking_service_address',
  'cf_booking_service_type',
  'cf_booking_number_of_signers',
  'cf_booking_special_instructions',
  'cf_booking_status',
  'cf_confirmation_sent_at',
  'cf_payment_status',
  'cf_payment_date',
  'cf_payment_invoice_number',
  'cf_payment_amount_paid',
  'cf_invoice_due_date',
  'cf_payment_failed_attempts',
  'cf_unique_referral_code',
  'cf_referral_code_assigned',
  'cf_referred_by_name_or_email',
  'cf_referral_code_used',
  'cf_referrer_contact_id',
  'cf_account_credit_referrer',
  'cf_satisfaction_score',
  'cf_consent_display_testimonial',
  'cf_testimonial_text',
  'cf_last_service_type',
  'cf_last_service_type_friendly_name',
  'cf_lifetime_value',
  'cf_no_show_count',
  'cf_no_show_reason',
  'cf_refund_request_amount',
  'cf_refund_request_reason',
  'cf_original_invoice_id',
  'cf_refund_processed_amount',
  'cf_refund_processed_date',
  'cf_refund_gateway_transaction_id',
  'cf_refund_status',
  'cf_onboarding_documents_received',
  'cf_reengagement_segment'
];
