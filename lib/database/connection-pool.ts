...
class DatabaseConnectionPool {
  ...
  private setupEventListeners(): void {
    // Query event logging
    (this.prismaClient as any).$on('query', (event: any) => {
      this.queryCount++;
    ...
    // Error event logging
    (this.prismaClient as any).$on('error', (event: any) => {
      this.errorCount++;
    ...
    // Info event logging
    (this.prismaClient as any).$on('info', (event: any) => {
    ...
    (this.prismaClient as any).$on('warn', (event: any) => {
