  ...
  try {
    ...
    const analyticsData = {
      ...
      timeAnalytics: metrics.peakDays.map(day => ({
        ...
        revenue: Math.floor((day.bookings / metrics.total_bookings) * metrics.total_revenue)
      })),
      pricingMetrics: {
