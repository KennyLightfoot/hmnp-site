  ...
  private setupNavigationObserver(): void {
    const observer = new PerformanceObserver((list) => {
      list.getEntries().forEach(entry => {
        ...
        this.metrics.set('dom-content-loaded', navEntry.domContentLoadedEventEnd - navEntry.activationStart);
        this.metrics.set('load-complete', navEntry.loadEventEnd - navEntry.activationStart);
