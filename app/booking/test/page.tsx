  ...
  return (
    <main className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">Booking Form Test Page</h1>

        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
          <p className="text-yellow-700">
            This page is for testing the booking form functionality. Use this to verify that all booking links
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              <Link href="/book" className="text-primary hover:underline">
                Test redirect from /book to /booking
              </Link>
            </li>
            <li>
