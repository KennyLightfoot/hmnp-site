...
const ThankYouGMBPage: NextPage = () => {
  ...
  useEffect(() => {
    ...
    //   window.gtag('event', 'generate_lead', { 'event_category': 'contact', 'event_label': 'gmb_form_submission' });
    //   console.log("Analytics: GMB Lead event tracked.");
    // }
  }, []);
...
export default ThankYouGMBPage; 