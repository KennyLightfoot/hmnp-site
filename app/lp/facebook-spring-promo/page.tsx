...
function CampaignLeadForm() {
  ...
  return (
    <LeadForm
      ...
      formTitle="Spring Promo: Exclusive Offer!"
      formDescription="Fill out your details below to claim your exclusive offer from our Facebook Spring Promotion."
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-800">Exclusive Spring Offer!</h1>
