...
const EstimatorStrip = dynamic(() => import('@/components/EstimatorStrip'), {
  ssr: false,
  loading: () => (
    <div className="py-10 text-center text-sm text-muted-foreground">Loading estimator…</div>
  ),
});
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-4 flex flex-wrap gap-2 text-xs">
              <span className="bg-white/10 border border-white/20 rounded-full px-3 py-1">
                Proof.com credential analysis
              </span>
              <span className="bg-white/10 border border-white/20 rounded-full px-3 py-1">
                KBA + ID validation
              </span>
              <span className="bg-white/10 border border-white/20 rounded-full px-3 py-1">
                Session recording archived 7 years
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="border-b py-8">
        <div className="container mx-auto px-4 flex flex-wrap items-center gap-4">
          <div className="text-sm text-slate-700">
            Available statewide • Live human support • Deposits processed via Stripe
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="p-5 border rounded-xl shadow-sm">
            ...
            <p className="text-sm text-black/70 mt-2">
              Valid government ID, device with camera/mic, stable internet ≥10 Mbps, and a quiet
              space.
            </p>
          </div>
          <div className="p-5 border rounded-xl shadow-sm">
          ...
          <div className="p-5 border rounded-xl shadow-sm">
            ...
            <p className="text-sm text-black/70 mt-2">
              Proof.com credential analysis, KBA, and audio/video recording archived for 7 years with
              secure storage.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-3 text-lg text-slate-600">
                Fill in your details and we send your secure RON session link. Average go-live in
                15–30 minutes during peak hours.
              </p>
            </div>
            <div className="bg-white border border-slate-200 rounded-2xl shadow-lg p-6 md:p-10">
              <Suspense
                fallback={<div className="text-center py-10 text-slate-500">Loading secure form…</div>}
              >
