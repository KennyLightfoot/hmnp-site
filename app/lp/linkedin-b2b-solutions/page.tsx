          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-gradient-to-br from-[#002147] to-[#003366] p-10 rounded-2xl text-white">
              ...
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg mb-6">
                <div className="text-center">
                  <div className="text-sm text-blue-200 mb-2">Partner plans start at</div>
                  <div className="text-3xl font-bold text-[#A52A2A] mb-2">$199/month</div>
                  <div className="text-xs text-blue-200">*Includes 15 notarizations/month (RON or mobile)</div>
                </div>
              </div>
