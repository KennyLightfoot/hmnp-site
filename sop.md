...
- **Service Tiers & Verification**:
  | Service Tier               | Verification Requirements                                 |
  |----------------------------|-----------------------------------------------------------|
  | Standard Notary            | Validate distance. For >2 docs or >2 signers, or urgent/off-hours needs, guide to Extended Hours Notary. |
  | Extended Hours Notary      | Confirm availability, suitable for urgent or larger standard jobs. |
  | Loan Signing Specialist    | Verify title company contact information.                 |
  | Specialty Notary Services  | Confirm specific requirements for the specialty service.  |
