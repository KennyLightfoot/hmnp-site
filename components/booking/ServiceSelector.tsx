...
const SERVICES: ServiceOption[] = [
  ...
  },
  {
    ...
    name: 'Starter Partner Subscription',
    price: 199,
    description: 'Priority access retainer for businesses with regular notary needs',
    hours: 'Mon-Fri 9am-5pm + RON 24/7',
    included: [
      '15 notarizations/month (RON or mobile)',
      '20-mile radius coverage',
      '$8 per extra stamp above 15',
      '30-day rollover on unused',
      'Priority booking over non-subscribers',
  ...
  },
  {
    ...
    price: 499,
    description: 'Full-service retainer for real estate teams, mortgage offices, and mid-size firms',
    hours: 'Daily 7am-9pm + RON 24/7',
    included: [
      '50 notarizations/month (RON or mobile)',
      '30-mile radius coverage',
      '1 free loan signing/month',
      '$7 per extra stamp above 50',
  ...
  },
  {
    ...
    name: 'Enterprise Partner Subscription',
    price: 1199,
    description: 'Enterprise-grade retainer for title companies, hospitals, and large firms',
    hours: '24/7 priority access',
    included: [
      '150 notarizations/month (RON or mobile)',
      '40-mile radius coverage',
      '3 free loan signings/month',
      '$6 per extra stamp above 150',
