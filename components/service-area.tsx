        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="bg-secondary/5 p-5 rounded-lg border border-secondary/10 mb-6">
                <div className="flex items-start">
                  <div className="bg-secondary p-2 rounded-full mr-3 shrink-0">
                    <MapPin className="h-5 w-5 text-white" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-secondary mb-1">Travel Made Simple</h3>
